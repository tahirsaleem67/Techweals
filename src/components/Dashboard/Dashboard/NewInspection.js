    ...
    return <>
        <div className='container-fluid '>
            <div className='row px-5 my-5 d-flex gap-5 justify-content-center'>
                ...
                {newInspection.reverse().map((data) => {
                    return <div className={`col-lg-5 col-sm-12 py-3 px-4 border recent ${recentClicked ? 'recent-clicked' : ''}`}>
                        <div><p className='text-center' style={{ fontSize: "30px", fontWeight: "700", color: "rgb(2, 2, 94)", }}>New Inspection Request</p></div>
