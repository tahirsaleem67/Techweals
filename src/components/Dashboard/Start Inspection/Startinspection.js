...
export const Startinspection = () => {
    ...
    let [startinspect, setStartinspect] = useState({})
    ...
    useEffect(() => {
        if (params.id) {
            axios.get('/start?id=' + params.id)
                .then((res) => {
                    setStartinspect(res.data)
                })
                .catch(error => {
    ...
    return <>
        <div className='container-fluid m-0 p-0'>
            <div className='row'>
                <div className='col'>
                    <h1 style={{ color: "#00008B", fontWeight: "700" }}>----Start Inspection----{startinspect.name}</h1>
                </div>
            </div>
            <div className='row'>
                <div className='col'>
                    <form onSubmit={handleSubmit(Inspection)} className='px-4 inspection-form'>
                        ...
                        <div className='row'>
                            <div className='col-lg-2 col-md-4 col-sm-4 mb-3'>
                                ...
                                <input required type="text"  defaultValue={startinspect.name}  {...register("clientName")} />
                            </div>
                            <div className='col-lg-2 col-md-4 col-sm-4 mb-3'>
                                <label>Client Number</label> <br />
                                <input required type="number"  defaultValue={startinspect.number} {...register("clientNumber")} />
                            </div>
                            <div className='col-lg-2 col-md-4 col-sm-4 mb-3'>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-lg-2 col-md-4 col-sm-4 mb-3'>
                                ...
                                <select {...register("BrakePedal")}>
                                    <option value="Responsive">Normal</option>
                                    <option value="Not Working">Not Working</option>
                                </select>
                            </div>
                            <div className='col-lg-2 col-md-4 col-sm-4 mb-3'>
                            ...
                            <div className='col-lg-2 col-md-4 col-sm-4 mb-3'>
                                ...
                                <select {...register("WindowsType")}>
                                    <option value="Working">Manual</option>
                                    <option value="not Working">Automatic</option>
                                </select>
                            </div>
                        ...
                        <div className='row'>
                            ...
                            <div className='col-lg-2 col-md-4 col-sm-4 mb-3'>
                                ...
                                <input type="text" value="Inspector" {...register("TestDriveDoneBy")} />
                            </div>
                        </div>
                        <div className='row'>
                            <div className='col-lg-12 col-sm-12 my-4'>
